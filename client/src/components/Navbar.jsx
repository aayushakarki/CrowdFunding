...
const Navbar = () => {
  ...
  const { connect, address, setSearchQuery } = useStateContext();

  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      <div className="lg:flex-1 flex flex-row max-w-[600px] py-2 pl-4 pr-2 h-[60px] bg-[#000000] rounded-[100px]">
        <input
          type="text"
      ...
      <div className="sm:flex hidden flex-row justify-end gap-4">
        <CustomButton
          ...
          styles={
            address
              ? "bg-[#1dc071] transition-transform duration-200 hover:scale-105"
              : "bg-[#8c6dfd] transition-transform duration-200 hover:scale-105"
          }
          handleClick={() => {
