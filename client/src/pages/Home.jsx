...
const Home = () => {
  ...
  const filteredCampaigns = campaigns.filter(campaign => {
    const matchesCategory = selectedCategory === 'All Campaigns' || campaign.category.toLowerCase() === selectedCategory.toLowerCase();
    const matchesSearchQuery = campaign.title.toLowerCase().startsWith(searchQuery.toLowerCase());
